    ...
    <footer className="py-4">
      <div className="container-xxl">
        <div className="row align-items-center">
          <div className="col-5">
            <div className="footer-top-data d-flex gap-30 align-text-center">
        ...
        <div className="social_icons d-flex align-items-center gap-30 mt-4">
          ...
          <div className="col-3">
            ...
            <div className="footer-links d-flex flex-column">
              ...
              <Link to="/shippingpolivacy" className="text-white py-2 mb-1">Shipping Policy</Link>
              <Link to="/termsconditions" className="text-white py-2 mb-1">Terms & Conditions</Link>
        ...
        <div className="row">
          <div className="col-12">
             <p className="text-center mb-0 text-white">
              &copy; { new Date().getFullYear()}, Powered by Logic Gate
              </p>
          </div>
        </div>
      </div>
